...
//    public void systemCalculatesPersonalisedTrailScores() {
//        categories = new HashSet<>(Arrays.asList("Wet", "Forest", "Alpine"));
//        matchMakingService.scoreTrail(categories);
//    }
    ...
    public void trailsOrderedByHighestToLowest() {
        List<Trail> orderedTrails = matchMakingService.getTrailsSortedByWeight();
