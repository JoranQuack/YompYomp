...
public class Hut {
    ...
    public Hut(int id, String name, String place, String region, boolean bookable, String facilities, String hasAlerts,
            String thumbnailURL, String webpageURL, String description, int x, int y, int docID, Date dateLoaded,
            String globalID, int x2, int y2) {
        this.id = id;
        this.name = name;
        this.place = place;
        this.region = region;
